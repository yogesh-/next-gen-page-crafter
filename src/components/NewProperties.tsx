            ...
            <div className="space-y-6">
              ...
              <div className="pt-6">
                ...
                <div className="flex flex-row gap-2 md:gap-4">
                  <button className="flex-1 md:flex-none px-2 py-1 md:px-8 md:py-3 bg-luxury-900 text-white rounded hover:bg-luxury-800 transition-colors text-sm md:text-base">
                    REGISTER NOW
                  </button>
                  <button className="flex-1 md:flex-none px-2 py-1 md:px-8 md:py-3 bg-luxury-50 text-luxury-900 rounded hover:bg-luxury-100 transition-colors flex items-center justify-center gap-1 text-sm md:text-base">
