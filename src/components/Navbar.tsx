...
const Navbar = () => {
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center">
            <img
              ...
              alt="Logo"
              className={`h-12 md:h-12 transition-opacity duration-300 ${
  ...
  className={`flex items-center gap-2 px-4 py-2 border border-green-400 text-green-400 font-bold rounded-full transition-all ${
